...
<main class="main-container">
    ...
    <div class="container" style="margin-top:-35px">
        <div class="d-flex  ">
            ...
            <!-- list uploaded -->
            <div class="row flex-nowrap " style="padding-left:10px; padding-right:10px;white-space: nowrap; width:770px; height: 300px ; overflow-x:scroll; overflow-y:hidden;scrollbar-width: none">
                <!-- list -->
                <div class="cardDashboard align-items-center" style="width:210px;height:280px;">
